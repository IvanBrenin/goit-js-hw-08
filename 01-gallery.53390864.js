...
const gallery = (0, _galleryItemsJs.galleryItems).map((item)=>`<a class="gallery__item" href="${item.original}"><img src="${item.preview}" alt="${item.description}" class="gallery__image"></img></a>`).join("");
