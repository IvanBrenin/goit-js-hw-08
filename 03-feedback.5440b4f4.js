...
formRef.addEventListener("input", (0, _lodashThrottleDefault.default)(formFieldsValues, 500));
...
function onFormSubmit(event) {
    ...
    if (event.currentTarget.elements.email.value === "" || event.currentTarget.elements.message.value === "") window.alert("Всі поля мають бути заповнені");
    else {
